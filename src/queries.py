...
def schedule_appointment():
    ...
    insert_appointment(conn, patient_id, doctor_name, appointment_date, status)
...
def cancel_appointment():
    ...
    cursor = conn.cursor()
    query = f"UPDATE appointments SET status = 'Canceled' WHERE appointment_id = {appointment_id}"
    cursor.execute(query)
    conn.commit()
